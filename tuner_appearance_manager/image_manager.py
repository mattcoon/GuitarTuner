...
class ImageManager(object):
    def __init__(self, main_path):
        self.bell_image = ImageTk.PhotoImage(
            Image.open(main_path + "/assets/images/bell.png").resize((50, 50), Image.LANCZOS))

        self.bell_hovered_image = ImageTk.PhotoImage(
            Image.open(main_path + "/assets/images/bell_hovered.png").resize((50, 50), Image.LANCZOS))

        self.bell_muted_image = ImageTk.PhotoImage(
            Image.open(main_path + "/assets/images/mutedBell.png").resize((50, 50), Image.LANCZOS))

        self.bell_muted_hovered_image = ImageTk.PhotoImage(
            Image.open(main_path + "/assets/images/mutedBell_hovered.png").resize((50, 50), Image.LANCZOS))
